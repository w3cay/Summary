...
最近也收到许多微博私信的鼓励和更正题目信息，后面会经常更新题目和答案到[github博客](http://markyun.github.io/)，但其他旧版本的分支和其他网站出现的拷贝版本上面的错误回答我也管不了嘞。希望更多的前端开发可以达到既能使用也会表达，对理论知识有自己的理解，也可根据下面的知识点一个一个去进阶学习,形成自己的职业技能链。
